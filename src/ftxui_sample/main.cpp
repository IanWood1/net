...
// configuration step. It creates a namespace called `net`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", net::cmake::project_name, net::cmake::project_version) };
